...
public record DriverDto(int Id, int tripsCountDriver, int cancelledCountDriver, DateTime registeredDriverDate, DateTime? lastTripDate, string? driverBio, string name, string lastname, string email, string phone);
public record CreateDriverDto(int userId, string? driverBio);
