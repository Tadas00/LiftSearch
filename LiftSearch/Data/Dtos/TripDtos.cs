...
public record TripDto(string Id, DateTime tripDate, DateTime lastEditTime, int seatsCount, int? startTime, int? endTime, double price, string description, string startCity, string endCity, TripStatus tripStatus);
